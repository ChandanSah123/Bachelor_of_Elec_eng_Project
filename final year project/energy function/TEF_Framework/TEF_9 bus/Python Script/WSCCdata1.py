...
# Solve Power Flow
psspy.dynamics_solution_param_2([_i]*8, [_f, _f, 0.00001, _f, _f, _f, _f, _f])
...
# 2. SPEED (Code 7) -> Becomes Channels 10, 11, 12
psspy.chsb(0, 1, [-1, -1, -1, 1, 7, 0])
# 3. MECHANICAL POWER (Code 3) -> Becomes Channels 4, 5, 6
# (Note: Previous code used 6 for Voltage. We changed it to 3 for Pmech)
psspy.chsb(0, 1, [-1, -1, -1, 1, 6, 0])
# 4. ELECTRICAL POWER (Code 2) -> Becomes Channels 7, 8, 9
psspy.chsb(0, 1, [-1, -1, -1, 1, 2, 0])

# 5. GENERATOR REACTIVE POWER (Qe) (Code 4)
...
if data_columns:
    ...
    print("Columns 7-9: Electrical Power (Pe)Mechanical Power (Pm)")
    print("Columns 10-12: Generator Active Power (P)")
    print("Columns 13-15: Generator Reactive Power (Q)")
else:
