% dyn9.m
% System data for IEEE-9 (used by TSA_BCU.m)
% --- Buses ---
Bus.con = [ ... 
  1  16.5  1  0  4  1;
  2  18  1  0  5  1;
...
PQ.con = [ ... 
  ...
  8  100  230  1.0   0.35  1.2  0.8  0  1;
  5  100  230  1.25  0.5   1.2  0.8  0  1;
];

% --- Synchronous machine (generator) data ---
% Each row corresponds to a machine. Columns follow the original packed format
Syn.con = [ ... 
...
% --- Exciter models (simple placeholders) ---
Exc.con = [ ... 
...
% --- Bus names (for plotting/display) ---
Bus.names = { ...
